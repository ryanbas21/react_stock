...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Ticker = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Stock = __webpack_require__(160);
	...
	var Ticker = function (_Component) {
	  ...
	  function Ticker(props) {
	    ...
	    _this.buyStock = _this.buyStock.bind(_this);
	    _this.state = {
	      stocks: [],
	      money: 50000
	    };
	    ...
	    value: function buyStock(e) {
	      ...
	      _jquery2.default.ajax({
	        ...
	        success: function success(data) {
	          ...
	          var newArr = _this2.state.stocks.slice(0);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'text', id: 'stockName', placeholder: 'Enter Symbol' })
	        ),
	        this.state.stocks
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stock = function Stock(props) {
	    return React.createElement(
	        ...
	        React.createElement('input', { type: 'text', id: 'stockName', placeholder: 'Enter Symbol' })
	    );
	};
